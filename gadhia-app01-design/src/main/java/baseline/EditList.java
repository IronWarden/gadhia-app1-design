...
public class EditList {
    ...
    public ArrayList<List> editDueDate(List list, List user, String edit) {
        // takes the list of lists and the to-do list the user want to edit
    ...
    public ArrayList<List> addNewItem(List list, List user,  String edit) {
    ...
    public ArrayList<List> deleteItem(List list, List user, int number) {
